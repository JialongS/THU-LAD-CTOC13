...
#define DACE_PATCH_VERSION 1

#define DACE_MEMORY_HYBRID 1
#define DACE_MEMORY_STATIC 2
#define DACE_MEMORY_DYNAMIC 3
#define DACE_MEMORY_MODEL DACE_MEMORY_DYNAMIC
#define DACE_MEMORY_MODEL_STR "DYNAMIC"
...
#define HAVE_UNDERSCORE_PREFIXED_BESSEL_FUNCTIONS
